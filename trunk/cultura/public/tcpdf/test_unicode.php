...
// 
// Description : Test page fotr TCPDF class
// 
// Author: Nicola Asuni
// 
// (c) Copyright:
...
$pdf->SetFont("FreeSerif", "", 12);
$utf8text = file_get_contents("cache/utf8test.txt", false); // get utf-8 text form file
...
$pdf->Cell(35,5,'Wine');
// set export values
$pdf->IncludeJS("f.exportValues=[\"Water\", \"Beer\", \"Wine\"];");
// check the second radiobutton
$pdf->IncludeJS("f.checkThisBox(1,true);");
$pdf->Ln(10);
